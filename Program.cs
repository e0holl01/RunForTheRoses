...
namespace RunForTheRoses
{
    class Program
    {
        ...
        //public static void LoadTrifecta()
        //{
        //    var ???
        //}
        //static void AddTrifecta()
        //Console.WriteLine("From the 2016 Kentucky Derby, pick your Trifecta.");
        
            //public static void saveTrifecta()
            //{
            //    var ???coursesJson = JsonConvert.SerializeObject(????Courses);
            //    var ???teachersJson = JsonConvert.SerializeObject(???Teachers);

                  //var coursesFile = File.Create("filepath.json");
                  //var teahersFile = File.Create("filepath.json");

            //using (var streamWriter = new StreamWriter(coursesFile))
                //{
                    //streamWriter.Write(coursesJson);
                //}
